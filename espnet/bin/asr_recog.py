...
# sys.path.remove("/home/espnet")
# import espnet
# print(espnet.__file__)
os.environ['PYTHON_EGG_CACHE'] = '/teamscratch/tts_intern_experiment/yuwu1'
...
def main(args):
    import espnet as test

    print("INFO",os.path.abspath(test.__file__))
    parser = get_parser()
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            if args.api == "v2":
                ...
                import espnet.asr.pytorch_backend.asr as test

                print(os.path.abspath(test.__file__))
